...
**Rotating Base:** To allow the arm to rotate around its base ended up being a notable challenge, as the specific gearbox design I utilized did not perform well with a direct load, which presses directly into the gearbox assembly, being placed on the output shaft. This meant I couldn't simply place the arm directly on-top of a gearbox, and had to find a way to transfer the majority of the arm's weight into the base and not through the gearbox itself. This was achieved by modelling two circular, semi-cylindric channels, one into the bottom of the arms bottom plate, which attached to the base motor, and one into the top of the base's top plate, which surrounded the output shaft of the gearbox. 6mm metal ball bearings were placed in this channel, allowing the arm to roll on them and rotate, akin to a complete bearing assembly, which allowed it to transfer the majority of its weight into the base, and not through the motor. The gearbox was then attached to the base through a hole in the center of the plate, surrounded by the channel 
